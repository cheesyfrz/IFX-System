...
namespace IFX_login
{
    public partial class transactiongbp : UserControl
    {
        public static transactiongbp inst {  get; set; }
        ...
        private void transactiongbp_Load(object sender, EventArgs e)
        {
            panel1.Hide();
        ...
        private void arrowup_btn_Click(object sender, EventArgs e)
        {
            if (currencyswap == false)
            {
                ...
                gbp.Location = new Point(45, 105);
                ph.Location = new Point(45, 319);
                gbp_lbl.Location = new Point(162, 141);
            ...
            {
                gbp.Location = new Point(45, 319);
                ph.Location = new Point(45, 105);
                gbp_lbl.Location = new Point(162, 343);
