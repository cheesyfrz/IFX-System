...
namespace IFX_login
{
    public partial class transactioncad : UserControl
    {
        public static transactioncad inst { get; set; }
        

        public transactioncad()
        {
            InitializeComponent();
            inst = this;
        }
        ...
        private void transactioncad_Load(object sender, EventArgs e)
        {
        ...
        private void arrowup_btn_Click(object sender, EventArgs e)
        {
            if (currencyswap == false)
            {
                ...
                cad.Location = new Point(45, 105);
                ph.Location = new Point(45, 319);
                cad_lbl.Location = new Point(162, 141);
            ...
            {
                cad.Location = new Point(45, 319);
                ph.Location = new Point(45, 105);
                cad_lbl.Location = new Point(162, 343);
