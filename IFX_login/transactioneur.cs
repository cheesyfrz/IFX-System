...
namespace IFX_login
{
    public partial class transactioneur : UserControl
    {
        public static transactioneur inst {  get; set; }
        ...
        private void transactioneur_Load(object sender, EventArgs e)
        {
            panel1.Hide();
        ...
        private void arrowup_btn_Click(object sender, EventArgs e)
        {
            if (currencyswap == false)
            {
                ...
                eur.Location = new Point(45, 105);
                ph.Location = new Point(45, 319);
                eur_lbl.Location = new Point(162, 141);
            ...
            {
                eur.Location = new Point(45, 319);
                ph.Location = new Point(45, 105);
                eur_lbl.Location = new Point(162, 343);
