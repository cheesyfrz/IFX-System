...
namespace IFX_login
{
    public partial class transactionaud : UserControl
    {
        public static transactionaud inst { get; set; }
        

        public transactionaud()
        {
            InitializeComponent();
            inst = this;
        }
        ...
        private void transactionaud_Load(object sender, EventArgs e)
        {
            panel1.Hide();
        ...
        private void cnvrt_btn_Click(object sender, EventArgs e)
        {
            ...
            if (yn == DialogResult.Yes)
            {
                ...
                if (currencyswap == false)
                {
                    ...
                    double audrate = GetExchangeRate(frm, to);
                    ...
                    newcstmrmoney = remain * rate;
                    /*newcstmrmoney -= .5;*/
                    newcstmrmoney = Convert.ToInt32(newcstmrmoney); //bayad ni customer
                    double final = newcstmrmoney / rate;
                    double sukli = cstmrmoney - newcstmrmoney;


                    double extramoney = rate - audrate;
                    double profit = 0;
                    profit = markup + tax;
                    profit += extramoney;
                    profit *= final;
                    convertedAmount = final; // ibibigay kay customer
                    double sales = 0;
                    sales += profit;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        toamount_tb.Text = convertedAmount.ToString("F0");
                        ...
                        try
                        {
                            ...
                            LRate.Text = rate.ToString();
                            LAmount.Text = amount.ToString();
                            LCAmount.Text = amount_tb.Text.ToString();
                            LDateTime.Text = formatteddate.ToString() + " " + formattedtime.ToString();
        ...
        private void arrowup_btn_Click(object sender, EventArgs e)
        {
            if (currencyswap == false)
            {
                ...
                aud.Location = new Point(45, 105);
                ph.Location = new Point(45, 319);
                aud_lbl.Location = new Point(162, 141);
            ...
            {
                aud.Location = new Point(45, 319);
                ph.Location = new Point(45, 105);
                aud_lbl.Location = new Point(162, 343);
