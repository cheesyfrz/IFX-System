...
namespace IFX_login
{
    public partial class transactionsgd : UserControl
    {
        public static transactionsgd inst {  get; set; }
        ...
        private void transactionsgd_Load(object sender, EventArgs e)
        {
            panel1.Hide();
        ...
        private void arrowup_btn_Click(object sender, EventArgs e)
        {
            if (currencyswap == false)
            {
                ...
                sgd.Location = new Point(45, 105);
                ph.Location = new Point(45, 319);
                sgd_lbl.Location = new Point(162, 141);
            ...
            {
                sgd.Location = new Point(45, 319);
                ph.Location = new Point(45, 105);
                sgd_lbl.Location = new Point(162, 343);
